 ...
 *
 */
package net.essorant.astraldisturbance;
...
@Mod("astral_disturbance")
public class AstralDisturbanceMod {
	public static final Logger LOGGER = LogManager.getLogger(AstralDisturbanceMod.class);
	public static final String MODID = "astral_disturbance";

	public AstralDisturbanceMod() {
